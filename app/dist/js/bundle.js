    ...
    function printNode(node) {
      ...
      function printPod(pod) {
        ...
        var createContainerCountDiv = function (containerCount) {
          return "<div class=' col-xs-4 label label-default'> " + "<a data-toggle='tooltip' href='#' title='Amount of containers'> C: " + containerCount + "</a>" + "</div>";
        };

        var createRestartCountDiv = function (restarts) {
          return "<div class=' col-xs-4 label label-" + suffix + "'> " + "<a data-toggle='tooltip' href='#' title='Amount of restarts'> R: " + restarts + "</a>" + "</div>";
        };

        var createUptimeDiv = function (uptime) {
          return "<div class=' col-xs-4 label label-default'> " + "<a data-toggle='tooltip' href='#' title='Pod Uptime'> " + uptime + "</a>" + "</div>";
        };

        nodeHtml += "<div class='dk-pod-box panel " + pulsatingClass + "'>" + "<div class='dk-pod-header panel-heading " + podStateClass + "'>" + pod.name + "</div>" + "<div class='row' >" + createContainerCountDiv(pod.container) + createRestartCountDiv(pod.restarts.count) + createUptimeDiv(pod.runningSince) + "</div>" + "</div>";
      }
